  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        name: "Android",
        slug: "android",
        stacks: [{ name: "Kotlin", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/kotlin/kotlin-original.svg", url: "https://kotlinlang.org" }],
      },
      {
        name: "Cross-Platform",
        slug: "cross-platform",
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        stacks: [{ name: "SQL", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/postgresql/postgresql-original.svg", url: "https://www.postgresql.org" }],
      },
    ],
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        stacks: [{ name: "SIEM Tools", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/linux/linux-original.svg", url: "https://www.splunk.com" }],
      },
    ],
  },
  {
...
const roles = [// Web
  ...
  // Cloud & Infra (fix: use the kept slug)
  {
    ...
    industrySlug: "cloud-infrastructure",
